...
import { markVGameSchema, removeMarkedVGameSchema } from "@anytrack/joi";
...
vGameRouter.delete('/mark/:id', userMiddleware, joiMiddleware(removeMarkedVGameSchema, 'params'), removeMarkedVGame)
